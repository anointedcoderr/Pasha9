...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'cashback', href: '/admin/cashback', icon: TrendingUp },
      { key: 'inAppNotifications', href: '/admin/in-app-notifications', icon: Bell },
      { key: 'notifications', href: ROUTES.admin.notifications, icon: Bell },
      { key: 'homepageVideos', href: '/admin/homepage-videos', icon: PlaySquare },
