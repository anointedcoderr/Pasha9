    ...
    >
      <span
        className={cn(
          ...
          s.box,
          remoteLogo ? 'bg-white' : 'bg-[linear-gradient(140deg,#FFE066_0%,#FFCC00_45%,#F5B400_75%,#A87200_100%)]',
      ...
      >
        {remoteLogo ? (
          ...
          <img src={remoteLogo} alt="Pasha 9" className="h-full w-full object-contain p-1" />
        ) : (
          <>
            <span
              aria-hidden
