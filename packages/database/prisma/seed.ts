...
async function seedRolesAndPermissions() {
  ...
  const permissions = [
    ...
    // Menu visibility (M2G Phase 5). One dedicated, staff-grantable code per
    // literal AdminSidebar row - a true one-to-one match, no grouping. This
    // is SEPARATE from the business codes above: a menu.*.view grant only
    // controls whether that exact sidebar item shows and whether its page
    // can be opened at all (sidebar filter + the client/server URL guards in
    // lib/auth/admin-sections.ts). It does not by itself unlock any save/
    // edit/approve action on that page - those still require the relevant
    // business permission above, unchanged, so granting someone
    // "Homepage: view" cannot let them save homepage content unless they
    // (or their role) also hold homepage.write.
    { key: 'menu.overview.view', label: 'Menu: Dashboard', group: 'menu' },
    { key: 'menu.deposits.view', label: 'Menu: Deposits', group: 'menu' },
    { key: 'menu.withdrawals.view', label: 'Menu: Withdrawals', group: 'menu' },
    { key: 'menu.transactions.view', label: 'Menu: Transaction Log', group: 'menu' },
    { key: 'menu.payments.view', label: 'Menu: Payments', group: 'menu' },
    { key: 'menu.payouts.view', label: 'Menu: Payouts', group: 'menu' },
    { key: 'menu.paymentMethods.view', label: 'Menu: Payment Methods', group: 'menu' },
    { key: 'menu.withdrawalLimits.view', label: 'Menu: Withdrawal Limits', group: 'menu' },
    { key: 'menu.paymentsReconciliation.view', label: 'Menu: Payments Reconciliation', group: 'menu' },
    { key: 'menu.operations.view', label: 'Menu: Operations Monitor', group: 'menu' },
    { key: 'menu.depositNotice.view', label: 'Menu: Deposit Notice', group: 'menu' },
    { key: 'menu.users.view', label: 'Menu: User Management', group: 'menu' },
    { key: 'menu.balance.view', label: 'Menu: Balance Management', group: 'menu' },
    { key: 'menu.referrals.view', label: 'Menu: Referrals', group: 'menu' },
    { key: 'menu.referralClaims.view', label: 'Menu: Referral Claims', group: 'menu' },
    { key: 'menu.recovery.view', label: 'Menu: Player Recovery', group: 'menu' },
    { key: 'menu.bonuses.view', label: 'Menu: Bonus Management', group: 'menu' },
    { key: 'menu.depositBonusTiers.view', label: 'Menu: Deposit Bonus Tiers', group: 'menu' },
    { key: 'menu.promotionBanners.view', label: 'Menu: Promotion Banners', group: 'menu' },
    { key: 'menu.affiliate.view', label: 'Menu: Affiliate', group: 'menu' },
    { key: 'menu.affiliateTiers.view', label: 'Menu: Affiliate Tiers', group: 'menu' },
    { key: 'menu.vip.view', label: 'Menu: VIP Club', group: 'menu' },
    { key: 'menu.website.view', label: 'Menu: Website', group: 'menu' },
    { key: 'menu.banners.view', label: 'Menu: Banners', group: 'menu' },
    { key: 'menu.popups.view', label: 'Menu: Popups', group: 'menu' },
    { key: 'menu.welcomePopup.view', label: 'Menu: Welcome Popup', group: 'menu' },
    { key: 'menu.promoText.view', label: 'Menu: Promo Text', group: 'menu' },
    { key: 'menu.homepage.view', label: 'Menu: Homepage', group: 'menu' },
    { key: 'menu.homepageSections.view', label: 'Menu: Homepage Sections', group: 'menu' },
    { key: 'menu.homepageBlocks.view', label: 'Menu: Homepage Blocks', group: 'menu' },
    { key: 'menu.homepagePromoPair.view', label: 'Menu: Homepage Promo Pair', group: 'menu' },
    { key: 'menu.homepageShortcuts.view', label: 'Menu: Homepage Shortcuts', group: 'menu' },
    { key: 'menu.sportsEvents.view', label: 'Menu: Sports Events', group: 'menu' },
    { key: 'menu.ambassador.view', label: 'Menu: Ambassador', group: 'menu' },
    { key: 'menu.brandAmbassadors.view', label: 'Menu: Brand Ambassadors', group: 'menu' },
    { key: 'menu.sponsors.view', label: 'Menu: Sponsors', group: 'menu' },
    { key: 'menu.publicPaymentMethods.view', label: 'Menu: Public Payment Methods', group: 'menu' },
    { key: 'menu.socialLinks.view', label: 'Menu: Social Links', group: 'menu' },
    { key: 'menu.lotto.view', label: 'Menu: Lottery', group: 'menu' },
    { key: 'menu.lottoBanners.view', label: 'Menu: Lottery Banners', group: 'menu' },
    { key: 'menu.rewards.view', label: 'Menu: Rewards', group: 'menu' },
    { key: 'menu.rewardClaims.view', label: 'Menu: Reward Claims', group: 'menu' },
    { key: 'menu.bettingPass.view', label: 'Menu: Betting Pass', group: 'menu' },
    { key: 'menu.bettingPassBanners.view', label: 'Menu: Betting Pass Banners', group: 'menu' },
    { key: 'menu.spinTiers.view', label: 'Menu: Spin Tiers', group: 'menu' },
    { key: 'menu.spinSegments.view', label: 'Menu: Spin Segments', group: 'menu' },
    { key: 'menu.nativeGames.view', label: 'Menu: Native Games', group: 'menu' },
    { key: 'menu.wingo.view', label: 'Menu: WinGo', group: 'menu' },
    { key: 'menu.tournaments.view', label: 'Menu: Tournaments', group: 'menu' },
    { key: 'menu.categories.view', label: 'Menu: Categories', group: 'menu' },
    { key: 'menu.providers.view', label: 'Menu: Game Providers', group: 'menu' },
    { key: 'menu.reports.view', label: 'Menu: Reports & Analytics', group: 'menu' },
    { key: 'menu.marketing.view', label: 'Menu: Marketing', group: 'menu' },
    { key: 'menu.promoCodes.view', label: 'Menu: Promo Codes', group: 'menu' },
    { key: 'menu.campaigns.view', label: 'Menu: Campaigns', group: 'menu' },
    { key: 'menu.cashback.view', label: 'Menu: Cashback', group: 'menu' },
    { key: 'menu.inAppNotifications.view', label: 'Menu: In-App Notifications', group: 'menu' },
    { key: 'menu.notifications.view', label: 'Menu: Notifications', group: 'menu' },
    { key: 'menu.homepageVideos.view', label: 'Menu: Homepage Videos', group: 'menu' },
    { key: 'menu.tracking.view', label: 'Menu: Tracking Pixels', group: 'menu' },
    { key: 'menu.whatsapp.view', label: 'Menu: WhatsApp', group: 'menu' },
    { key: 'menu.security.view', label: 'Menu: Security Center', group: 'menu' },
    { key: 'menu.passwordResets.view', label: 'Menu: Password Resets', group: 'menu' },
    { key: 'menu.staff.view', label: 'Menu: Staff & Sub-admins', group: 'menu' },
    { key: 'menu.integrations.view', label: 'Menu: Integrations', group: 'menu' },
    { key: 'menu.depositPrompt.view', label: 'Menu: Deposit Prompt', group: 'menu' },
    { key: 'menu.support.view', label: 'Menu: Support Messages', group: 'menu' },
    { key: 'menu.settings.view', label: 'Menu: System Settings', group: 'menu' },
    { key: 'menu.activity.view', label: 'Menu: Activity Log', group: 'menu' },
    { key: 'menu.handover.view', label: 'Menu: Handover', group: 'menu' },
  ];
